...
q2 = Question('Государственный язык ОАЭ', 'Португальский', 'Испанский', 'Итальянский', 'Арабский')
q3 = Question('Какого цвета нет на флаге России?', 'Зелёного', 'Синего', 'Белого', 'Красного')
...
q10 = Question('Когда начинается мезяц Рамадан?', '22 марта', '17 марта', '23 марта', '18 марта')
